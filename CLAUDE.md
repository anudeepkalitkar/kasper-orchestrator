...
[architect](.claude/agents/architect.md) (turns a goal into a design spec in
...
[--stack <name>...]` ([codex_seat.py](.claude/scripts/codex_seat.py)) — whose prompt is the seat's
role file in [codex/](.claude/codex/), then one stack section from [codex/stacks/](.claude/codex/stacks/)
